...
def game():
    ...
    print(f"Настя: \"{person['Имя']}, что там? От кого?\"\n")
    ...
    if choice == 1:
        ...
        print(
            f"\nВечером {person['Имя']} вызвала такси и поехала по указанному в письме адресу. По приезде её встретил высокий мужчина в черной маске и ударил по голове. {person['Имя']} отключилась.")
